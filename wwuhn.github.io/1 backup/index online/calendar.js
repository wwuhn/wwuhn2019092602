...
/*农历的另一年份时，需更改6处（第6处是节气更改，作为变量中的字符的"2011"不更改）*/
		...
		case "十二月二三":cnym=cnym+"&nbsp;"+"立春";break;
		case "正月初九":cnym=cnym+"&nbsp;"+"雨水";break;
		case "正月二四":cnym=cnym+"&nbsp;"+"惊蜇";break;
		case "二月初九":cnym=cnym+"&nbsp;"+"春分";break;
		case "二月二四":cnym=cnym+"&nbsp;"+"清明";break;
		case "三月十一":cnym=cnym+"&nbsp;"+"谷雨";break;
		
		case "三月二六":cnym=cnym+"&nbsp;"+"立夏";break;
		case "四月十二":cnym=cnym+"&nbsp;"+"小满";break;	
		case "四月二七":cnym=cnym+"&nbsp;"+"芒种";break;
		case "五月十四":cnym=cnym+"&nbsp;"+"夏至";break;
		case "五月二十":cnym=cnym+"&nbsp;"+"小暑";break;
		...
		case "十月二十":cnym=cnym+"&nbsp;"+"小雪";break;														
		case "十一月初五":cnym=cnym+"&nbsp;"+"大雪";break;	
		case "十一月二十":cnym=cnym+"&nbsp;"+"冬至";break;								
		case "十二月初五":cnym=cnym+"&nbsp;"+"小寒";break;	
		case "十二月二十":cnym=cnym+"&nbsp;"+"大寒";break;
